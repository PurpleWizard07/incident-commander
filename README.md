...
| | |
|---|---|
| **Lighthouse** | Agentic Browsing **4/4** checks passing; performance 0.99, accessibility 1.0, best-practices 1.0, SEO 1.0 (desktop preset, matching the judge environment). Report: [`docs/lighthouse-report.report.html`](docs/lighthouse-report.report.html) · Screenshot: [`docs/lighthouse-scores.png`](docs/lighthouse-scores.png) |
